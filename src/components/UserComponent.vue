<template>
	<div id="UserComponent" class="w-8">
		...
		>
			...
			<div class="text-gray-300">Francisco Zapata</div>
			<div class="text-gray-300">drfcozapata@gmail.com</div>
		</div>

		<div v-show="openMenu" class="absolute z-10 w-80 right-2 bg-white top-14 rounded-lg">
			<div class="w-full flex justify-center">
				<img src="https://via.placeholder.com/70" class="rounded-full w-20 mt-4" />
			</div>
